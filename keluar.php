                          ...
                          <div class="table-responsive" >
                              <table class="table table-bordered table-hover table-striped" id="datatables" style="width:100%">
                                <thead>
                                 ...
                                 <tbody>
                                 <?php
                                    $ambil = mysqli_query($conn, "SELECT * FROM keluar k, stock s WHERE s.idbarang = k.idbarang");
                                  ...
                                  ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                              ...
                                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idk;?>"><i class="fa fa-trash"> </i> hapus</button>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <input type="submit" class="btn btn-primary" name="hapusbarangkeluar" value="hapus" id="">
                                                </div>
                                              </form>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" class="close" data-dismiss="modal">cancel</button>
                                    <input type="submit" class="btn btn-primary" name="keluar" value="simpan" id="">
                                  </div>
                                </form>
